...
_G.packer_plugins = {
  ...
  ["nvim-dap-python"] = {
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/nvim-dap-python",
  ...
  ["run-with-me.vim"] = {
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/run-with-me.vim",
